...
def wait_for_portgres(host, max_retries=5, delay_seconds=5):
  ...
  while retries < max_retries:
    try:
      ...
      if "accepting connections" in result.stdout:
        print("Successfully connected to Portgres")
        return True
    except subprocess.CalledProcessError as e:
      print(f"Error connecting to Portgres: {e}")
      retries += 1
...
print("Successfully dumped source database...")
